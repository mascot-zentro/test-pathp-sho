...
function Stat({ label, value, icon: Icon, tone = "default", delta }: { label: string; value: string; icon?: React.ComponentType<{ className?: string }>; tone?: "default" | "accent" | "success" | "warn"; delta?: number | null }) {
    ...
    <Card className="shadow-sm">
      <CardContent className="p-5 flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          {showDelta && (
            <div className={`text-xs mt-1 flex items-center gap-0.5 ${up ? "text-emerald-600" : "text-destructive"}`}>
